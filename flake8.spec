...
%prep
%setup -q -n flake8-3.8.4
cd %{_builddir}/flake8-3.8.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607981345
...
cp %{_builddir}/flake8-3.8.4/LICENSE %{buildroot}/usr/share/package-licenses/flake8/a2566e0d5e0f401fe89c88d497209f7e58ad1f80
