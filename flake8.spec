...
Source0  : https://files.pythonhosted.org/packages/76/ef/63ca8e9026a942af5da9380481c51d9a51326af65d8051fc166ab858bbdb/flake8-3.9.0.tar.gz
...
%prep
%setup -q -n flake8-3.9.0
cd %{_builddir}/flake8-3.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615845871
...
cp %{_builddir}/flake8-3.9.0/LICENSE %{buildroot}/usr/share/package-licenses/flake8/a2566e0d5e0f401fe89c88d497209f7e58ad1f80
