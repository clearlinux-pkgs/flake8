...
Source0  : https://files.pythonhosted.org/packages/73/9e/dfb9413d2962433551a93927be524a1b4369e4ac317ca3231191c6933ae7/flake8-3.8.1.tar.gz
...
%prep
%setup -q -n flake8-3.8.1
cd %{_builddir}/flake8-3.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589310861
...
cp %{_builddir}/flake8-3.8.1/LICENSE %{buildroot}/usr/share/package-licenses/flake8/a2566e0d5e0f401fe89c88d497209f7e58ad1f80
