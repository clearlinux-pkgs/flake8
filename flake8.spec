...
Source0  : https://files.pythonhosted.org/packages/10/b1/ef9620afac4a8794e631e54bbcd2f70257dee04693ea8fd959d57b89714e/flake8-3.8.2.tar.gz
...
%prep
%setup -q -n flake8-3.8.2
cd %{_builddir}/flake8-3.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590467226
...
cp %{_builddir}/flake8-3.8.2/LICENSE %{buildroot}/usr/share/package-licenses/flake8/a2566e0d5e0f401fe89c88d497209f7e58ad1f80
