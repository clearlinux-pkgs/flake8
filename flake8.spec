...
Source0  : https://files.pythonhosted.org/packages/99/eb/cc2bbe9b242a79d2c5820911f21875a138aafa3dc2c3b9b34ba714f9fef9/flake8-3.8.3.tar.gz
...
%prep
%setup -q -n flake8-3.8.3
cd %{_builddir}/flake8-3.8.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591755589
...
cp %{_builddir}/flake8-3.8.3/LICENSE %{buildroot}/usr/share/package-licenses/flake8/a2566e0d5e0f401fe89c88d497209f7e58ad1f80
